...
class Person:
    ...
    def first_name(self, first_name: str):
        if first_name.isalpha() or first_name == '':
...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str, student_data: list):
        ...
        try:
            ...
            student_data = [Student(first_name=students["FirstName"],
                                    last_name=students["LastName"],
                                    course_name=students["CourseName"]) for students in json_students]
    ...
    def write_data_to_file(file_name: str, student_data: list):
        ...
        try:
            ...
            json_students = [{"FirstName": student.first_name,
...
student_data = FileProcessor.read_data_from_file(file_name=FILE_NAME, student_data=students)
